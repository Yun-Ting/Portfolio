...
//緩慢滑動
$(document).on('click', '.myanimate', function(event){
...
$(window).mousemove(function(evt){
  ...
  if (pagex<catplace - 50)
    $("#cat").attr("src","https://s3-us-west-2.amazonaws.com/s.cdpn.io/703747/whale_left.svg");
  
  else if (pagex>catplace  + 50)
    $("#cat").attr("src","https://s3-us-west-2.amazonaws.com/s.cdpn.io/703747/whale_right.svg");
  
  else
    $("#cat").attr("src","https://s3-us-west-2.amazonaws.com/s.cdpn.io/703747/whale_top.svg");
  
  //左上 / 右上
  if (pagex<catplace - 50 && pagey< cattop)
    $("#cat").attr("src","https://s3-us-west-2.amazonaws.com/s.cdpn.io/703747/whale_lefttop.svg");
  
  if (pagex>catplace + 50 && pagey< cattop)
    $("#cat").attr("src","https://s3-us-west-2.amazonaws.com/s.cdpn.io/703747/whale_righttop.svg");
